...
def test_cassandra_node_jmx_port_conflict_exits(mock_cluster, mock_options):
    """
...
def test_scylla_node_jmx_port_conflict_allowed(mock_cluster, mock_options):
    """
...
def test_scylla_node_explicit_jmx_port_allowed(mock_cluster, mock_options):
    """
