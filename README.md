...
CCM supports creating and interacting with DSE clusters using the `--dse` option:

```bash
ccm create dse_cluster --dse -v 6.8.0 -n 3 -s
```

See `ccm create -h` for DSE-specific options including authentication.
